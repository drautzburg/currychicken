...
ex_lgr = loggers [
          ...
          logger (logEveryT 60000 0)  (Fmt fmt3), 
          logger (logEveryT 1000000 1000000)  (Fmt fmt4) 
          ]
        where
            ...
            fmt4 (t,(evt,dom))     = [printf "t=%12.2f - One Million !!!" t]
...
ex_log0 :: [(Timed String)]
ex_log0 = [(0.0, "Welcome to insite")] 
